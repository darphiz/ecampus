# Generated by Django 3.0.6 on 2021-09-17 17:48

import cbt.models
import cbt.validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cbt.Category', verbose_name='Category')),
            ],
            options={
                'verbose_name': 'Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cbt.Quiz', verbose_name='Quiz')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cbt.Category', verbose_name='Category')),
                ('quiz', models.ManyToManyField(blank=True, to='cbt.Quiz', verbose_name='Quiz')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=cbt.models.upload_csv_file, validators=[cbt.validators.csv_file_validator])),
