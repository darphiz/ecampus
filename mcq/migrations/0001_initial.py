    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer_order', models.CharField(choices=[('content', 'Content'), ('none', 'None'), ('random', 'Random')], default='Random', help_text='The order in which multichoice                     answer options are displayed                     to the user', max_length=30, verbose_name='Answer Order')),
            ],
            options={
